/*
 * NFindPreferenceOpNode.java - part of the GATOR project
 *
...
public class NFindPreferenceOpNode extends NOpNode{
    public NFindPreferenceOpNode(NNode idNode, NNode receiverNode,
