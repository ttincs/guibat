...
public class AndroidView implements IAndroidView {
  ...
  public IAndroidView deepCopy() {
    ...
    while (!work.isEmpty()) {
      ...
      tgt.contentDescription = src.contentDescription;
      tgt.imageResource = src.imageResource;
...
//    }
    ...
    if (!guiName.contains(".")) {
      ...
      if (!classExists(cls)) {
        cls = "android.preference." + guiName;
      }
      res = Scene.v().loadClassAndSupport(cls);
    } else {
      res = Scene.v().loadClassAndSupport(guiName);
  ...
  public void save(int guiId, String text, String hint, String tooltip, String contentDescription, String imageResource, String guiName) {
    Integer i = null;
    if (guiId != -1) {
      i = new Integer(guiId);
    }
  ...
  public void setImageResource(String text) {
  ...
  public static class Type {
    ...
    public static String APP_MENU = "app:menu";
    public static String APP_HEADER_LAYOUT = "app:headerLayout";
    public static String ANDROID_NAME = "android:name";
    public static String ANDROID_FRAGMENT = "android:fragment";
  }
}
