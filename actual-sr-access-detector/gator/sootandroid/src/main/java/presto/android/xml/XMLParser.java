...
public interface XMLParser {
  abstract class AbstractXMLParser implements XMLParser {
    ...
    protected final HashMap<String, String> activityLabels = Maps.newHashMap();
    protected final HashMap<String, String> usesPermissions = Maps.newHashMap();
  ...
  // Preference
  Set<Integer> getApplicationPreferenceIdValues();

  Set<Integer> getApplicationPreferenceHeaderIdValues();

  String getApplicationPreferenceName(Integer value);

  Set<String> getApplicationPreferenceKeys();

  Set<String> getImageFiles(String resName);

  Set<String> getImageFiles(int resId);
