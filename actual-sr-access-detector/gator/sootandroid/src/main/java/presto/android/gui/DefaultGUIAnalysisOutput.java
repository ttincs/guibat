...
public class DefaultGUIAnalysisOutput implements GUIAnalysisOutput {
  ...
  @Override
  public boolean isOnSharedPreferenceChanged(SootMethod handler) {
    return handler.getSubSignature().contains(MethodNames.onSharedPreferenceChangedSubSig);
  }

  @Override
  public boolean isOnPreferenceClick(SootMethod handler){
    return handler.getSubSignature().contains(MethodNames.onPreferenceClickSubSig);
  }

  @Override
  public boolean isOnPreferenceChange(SootMethod handler){
    return handler.getSubSignature().contains(MethodNames.onPreferenceChangeSubSig);
  }

  @Override
  public HashMap<String, String> getActivityLabels() {
    return analysis.xmlParser.getActivityLabels();
  }

    @Override
    public HashMap<String, String> getUsesPermissions() {
        return analysis.xmlParser.getUsesPermissions();
    }

    @Override
    public Set<PermissionNode> getUsedPermissions() {
        return analysis.flowgraph.usedPermissionSet;
    }

    @Override
    public Set<String> getRequestPermissionStmts() {
      return analysis.flowgraph.requestPermissionStmtSet;
    }
}
